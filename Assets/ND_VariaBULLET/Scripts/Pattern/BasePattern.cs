...
namespace ND_VariaBULLET
{
    public abstract class BasePattern : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            GameEventManager.Instance.StartListening<bool>(TyperEvent.OnUpdateShooting, EventAutoShooting);
        ...
        {
            GameEventManager.Instance.StopListening<bool>(TyperEvent.OnUpdateShooting, EventAutoShooting);
        }
        public void EventAutoShooting(bool value)
        {
            TriggerAutoFire = value;
        }
